...
const markersData = [
    ...
    { id: "grey-havens", name: "Grey Havens", x: "17.90%", y: "31.50%", type: "good" },
    { id: "the-shire", name: "The Shire", x: "26.21%", y: "30.64%", type: "good" },
    { id: "rivendell", name: "Rivendell", x: "44.32%", y: "30.82%", type: "good" },
    { id: "helms-deep", name: "Helm’s Deep", x: "44.64%", y: "60.62%", type: "good" },
    { id: "lorien", name: "Lórien", x: "52.12%", y: "44.48%", type: "good" },
    { id: "minas-tirith", name: "Minas Tirith", x: "61.58%", y: "68.39%", type: "good" },
    ...
    { id: "dol-guldor", name: "Dol Guldor", x: "58.38%", y: "41.55%", type: "evil" },
    { id: "minas-morgul", name: "Minas Morgul", x: "70.10%", y: "68.24%", type: "evil" },
    { id: "black-gate", name: "Black Gate", x: "70.19%", y: "57.47%", type: "evil" },
    { id: "mount-doom", name: "Mount Doom", x: "75.69%", y: "63.68%", type: "evil" },
    { id: "barad-dur", name: "Barad-dûr", x: "82.12%", y: "63.83%", type: "evil" },
    { id: "near-harad", name: "Near Harad", x: "86.60%", y: "89.5%", type: "evil" },
    // Neutral / contested locations
    { id: "eregion", name: "Eregion", x: "41.29%", y: "42.58%", type: "neutral" },
    { id: "misty-mountains", name: "Misty Mountains", x: "47.61%", y: "37.69%", type: "neutral" },
    { id: "fangorn", name: "Fangorn", x: "47.94%", y: "50.24%", type: "neutral" },
    { id: "mirkwood", name: "Mirkwood", x: "57.08%", y: "27.85%", type: "neutral" }
];
